...
var o10798 = temp__5821__auto__;
var temp__5821__auto____$1 = (o10798["core"]);
if(cljs.core.truth_(temp__5821__auto____$1)){
var o10799 = temp__5821__auto____$1;
return (o10799["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__10151__auto__ = f;
return (o__10151__auto__["toString"]).call(o__10151__auto__);
} else {
return "";
}
}catch (e10800){var _ = e10800;
return "";
}});
...
try{var o__10151__auto___10802 = t;
(o__10151__auto___10802["cljs$lang$ctorPrWriter"]).call(o__10151__auto___10802,t,writer);
}catch (e10801){var __10803 = e10801;
}
...
var char_code = (function (){var o__10151__auto__ = (new String(char$));
return (o__10151__auto__["charCodeAt"]).call(o__10151__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__10151__auto__ = String;
return (o__10151__auto__["fromCharCode"]).call(o__10151__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__10804 = num_code;
switch (G__10804) {
case (1):
return (185);
...
var o__10151__auto__ = String;
return (o__10151__auto__["fromCharCode"]).call(o__10151__auto__,superscript_code);
});
/**
...
}catch (e10806){var _e__10158__auto__ = e10806;
return false;
}})())){
...
var vec__10807 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__10807,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__10812){
var vec__10813 = p__10812;
var ns_detector = cljs.core.nth.call(null,vec__10813,(0),null);
...
var G__10819 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__10820 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__10819;
remaining_tokens = G__10820;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq10810){
var G__10811 = cljs.core.first.call(null,seq10810);
var seq10810__$1 = cljs.core.next.call(null,seq10810);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10811,seq10810__$1);
}));
...
var vec__10824 = cljs.core.split_with.call(null,(function (p1__10823_SHARP_){
return cljs.core.not_EQ_.call(null,p1__10823_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__10824,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__10824,(1),null);
...
var vec__10830 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__10830,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__10830,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__10833 = cljs.core.rest.call(null,remaining_tokens);
var G__10834 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__10833;
name_tokens = G__10834;
continue;
} else {
...
var vec__10837 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__10837,(0),null);
var arity = cljs.core.nth.call(null,vec__10837,(1),null);
var vec__10840 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__10840,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__10840,(1),null);
var vec__10843 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__10843,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__10843,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__10843,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__10843,(3),null);
...
var vec__10849 = result;
var munged_ns = cljs.core.nth.call(null,vec__10849,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__10849,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__10849,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__10849,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__10849,(4),null);
var arity = cljs.core.nth.call(null,vec__10849,(5),null);
...
if(cljs.core.truth_(temp__5821__auto__)){
var vec__10853 = temp__5821__auto__;
var munged_name = cljs.core.nth.call(null,vec__10853,(0),null);
var args = cljs.core.nth.call(null,vec__10853,(1),null);
var vec__10856 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__10856,(0),null);
var name = cljs.core.nth.call(null,vec__10856,(1),null);
...
var G__10859 = (arity + (1));
var G__10860 = (function (){var temp__5821__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5821__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__10861){
var vec__10862 = p__10861;
var arity = cljs.core.nth.call(null,vec__10862,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__10862,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__10865_SHARP_){
return cljs.core.get.call(null,arities,p1__10865_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__10866_SHARP_){
return cljs.core.drop.call(null,(2),p1__10866_SHARP_);
}),sorted_infos);
...
var args__5732__auto__ = [];
var len__5726__auto___10873 = arguments.length;
var i__5727__auto___10874 = (0);
while(true){
if((i__5727__auto___10874 < len__5726__auto___10873)){
args__5732__auto__.push((arguments[i__5727__auto___10874]));

var G__10875 = (i__5727__auto___10874 + (1));
i__5727__auto___10874 = G__10875;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__10869){
var vec__10870 = p__10869;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__10870,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq10867){
var G__10868 = cljs.core.first.call(null,seq10867);
var seq10867__$1 = cljs.core.next.call(null,seq10867);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10868,seq10867__$1);
}));
...
var map__10878 = options;
var map__10878__$1 = cljs.core.__destructure_map.call(null,map__10878);
var include_ns_QMARK_ = cljs.core.get.call(null,map__10878__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__10878__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__10878__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__10878__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__10879 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__10879,(0),null);
var fn_name = cljs.core.nth.call(null,vec__10879,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__10879,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__10879,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__10879,(4),null);
var arity = cljs.core.nth.call(null,vec__10879,(5),null);
...
var o__10151__auto__ = f;
return (o__10151__auto__["getBasis"]).call(o__10151__auto__);
});
/**
...
}catch (e10882){var _e__10158__auto__ = e10882;
...
var G__10883 = (obj[cljs.core.first.call(null,path)]);
var G__10884 = cljs.core.rest.call(null,path);
obj = G__10883;
path = G__10884;
continue;
} else {
...
var _STAR_ = (function (accum,p__10885){
var vec__10886 = p__10885;
var bit = cljs.core.nth.call(null,vec__10886,(0),null);
var protocol = cljs.core.nth.call(null,vec__10886,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__10889){
var vec__10890 = p__10889;
var ns = cljs.core.nth.call(null,vec__10890,(0),null);
var name = cljs.core.nth.call(null,vec__10890,(1),null);
var selector = cljs.core.nth.call(null,vec__10890,(2),null);
...
var post_process = (function (p__10894){
var vec__10895 = p__10894;
var munged_name = cljs.core.nth.call(null,vec__10895,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__10895,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__10893_SHARP_){
return (obj[cljs.core.first.call(null,p1__10893_SHARP_)]);
}),sorted_matches);
