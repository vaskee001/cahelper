...
var G__10900 = devtools.prefs.pref.call(null,v);
v = G__10900;
continue;
} else {
return v;
...
}catch (e10901){var _e__10158__auto__ = e10901;
return false;
}})();
...
}catch (e10903){var _e__10158__auto__ = e10903;
return false;
}})();
...
}catch (e10905){var _e__10158__auto__ = e10905;
return false;
}}
}
});
...
var vec__10907 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__10907,(0),null);
var name = cljs.core.nth.call(null,vec__10907,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10910_SHARP_);
}),template);
});
