...
var len__5726__auto___10939 = arguments.length;
var i__5727__auto___10940 = (0);
while(true){
if((i__5727__auto___10940 < len__5726__auto___10939)){
args__5732__auto__.push((arguments[i__5727__auto___10940]));

var G__10941 = (i__5727__auto___10940 + (1));
i__5727__auto___10940 = G__10941;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq10936){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10937,G__10938,seq10936__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__10942_SHARP_){
return (!((cljs.core.meta.call(null,p1__10942_SHARP_) == null)));
})))){
...
var map__10943 = opts;
var map__10943__$1 = cljs.core.__destructure_map.call(null,map__10943);
var markup_db = cljs.core.get.call(null,map__10943__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e10944){var _e__10158__auto__ = e10944;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e10946){var _e__10158__auto__ = e10946;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__10948 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__10949 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__10949);
...
var map__10950 = opts;
var map__10950__$1 = cljs.core.__destructure_map.call(null,map__10950);
var markup_db = cljs.core.get.call(null,map__10950__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__10948);
}});
...
var temp__5821__auto___10954 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5821__auto___10954)){
var managed_print_level_10955 = temp__5821__auto___10954;
var _STAR_print_level_STAR__orig_val__10952_10956 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__10953_10957 = managed_print_level_10955;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__10953_10957);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__10951_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__10951_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__10952_10956);
}} else {
job_fn.call(null);
}
