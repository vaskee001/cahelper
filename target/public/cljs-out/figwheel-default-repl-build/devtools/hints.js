...
var map__13097 = top_item;
var map__13097__$1 = cljs.core.__destructure_map.call(null,map__13097);
var file = cljs.core.get.call(null,map__13097__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__13097__$1,new cljs.core.Keyword(null,"line","line",212345235));
...
}catch (e13096){var _e = e13096;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5821__auto___13098 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5821__auto___13098)){
var seen_errors_13099 = temp__5821__auto___13098;
if(cljs.core.truth_(seen_errors_13099.has(self))){
} else {
seen_errors_13099.add(self);

var temp__5823__auto___13100 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5823__auto___13100)){
var sense_13101 = temp__5823__auto___13100;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_13101)].join(''));
} else {
}
}
} else {
